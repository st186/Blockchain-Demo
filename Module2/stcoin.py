# -*- coding: utf-8 -*-
"""
Created on Mon Dec  7 22:34:02 2020
...
# To be installed
# Flask==0.12.21: pip install Flask==0.12.2
# Postman HTTP Client: https://www.getpostman.com
# requests==0.2.4: pip install requests==0.2.4
...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver= 'Subham', amount = 1)
...
def replace_chain():
    ...
    if is_chain_replaced:
        response = {'message' : 'The nodes had different chains so the chain was replaced by longest chain, ',
